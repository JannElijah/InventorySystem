...
class StockOutView(ctk.CTkFrame):
    def __init__(self, parent, db, user):
        ...
        for i, h in enumerate(headers):
            ctk.CTkLabel(h_frame, text=h, font=("Arial", 12, "bold"), width=widths[i], text_color=Colors.TEXT_PRIMARY).pack(side="left", padx=5)
    ...
    def update_cart_ui(self):
        ...
        for item in self.cart:
            ...
            ctk.CTkLabel(row, text=str(p.stock_quantity), width=widths[1], text_color=stock_color).pack(side="left", padx=5)
